  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        inphrosync: {
          teal: "hsl(var(--inphrosync-teal))",
          violet: "hsl(var(--inphrosync-violet))",
          "bg-start": "hsl(var(--inphrosync-bg-start))",
          "bg-end": "hsl(var(--inphrosync-bg-end))",
        },
        dna: {
          film: "hsl(var(--dna-film))",
          music: "hsl(var(--dna-music))",
          tv: "hsl(var(--dna-tv))",
          gaming: "hsl(var(--dna-gaming))",
          youtube: "hsl(var(--dna-youtube))",
