...
interface StepTwoGamingProps {
  userId: string;
  onComplete: () => void;
}

const contentTypes = ["AAA Games", "Indie Games", "Mobile Games", "Esports", "Game Streaming", "VR/AR Games"];
const insights = ["Player Behavior", "Genre Preferences", "Platform Trends", "Monetization", "Competitive Gaming"];

const StepTwoGaming = ({ userId, onComplete }: StepTwoGamingProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await supabase.from("gaming_profiles").upsert({
        user_id: userId,
      ...
      toast.error(error.message || "Failed to save gaming profile");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold">🎮 Gaming Organization Profile</h2>
        <p className="text-muted-foreground">Tell us about your gaming organization to help you access relevant audience insights!</p>
      </div>
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder="e.g., Epic Games, Riot Games"
            required
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          >
            ...
            <SelectContent className="bg-popover z-50">
              ...
              <SelectItem value="publisher">Game Publisher</SelectItem>
              <SelectItem value="studio">Game Studio</SelectItem>
              <SelectItem value="esports">Esports Organization</SelectItem>
              <SelectItem value="platform">Gaming Platform</SelectItem>
            </SelectContent>
          </Select>
        </div>
        ...
        <div className="space-y-2">
          ...
          >
            ...
            <SelectContent className="bg-popover z-50">
              <SelectItem value="game-director">Game Director</SelectItem>
